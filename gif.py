...
if not api_key:
    raise ValueError("OpenAI API key not found. Please create a .env file with the following content:\nOPENAI_API_KEY='your_api_key_here'")
...
def main():
    query = "Your input query here"  # Replace with actual input query
    try:
